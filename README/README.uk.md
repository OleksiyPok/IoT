...
Обробка даних сенсорів відбувається у модулі `telemetry`.

### Структура даних

Нижче приведені структури даних у проекті
...
### Внутрішні регістри статусу

Для збереження стану кнопок та індикаторів (а також для майбутньої можливості віддаленого зчитування та керування ними) використовуються два регістри прапорців стану: `buttonStatus` та `ledStatus`.
